...
const contestSchema = new mongoose.Schema(
  {
    ...
    batch: { type: String, default: 'default', index: true, trim: true },
    description: { type: String, default: '' },
    // Specific problem slugs assigned to this contest/batch.
    // If empty, falls back to all published problems in level.
...
contestSchema.methods.toStatePayload = function toStatePayload() {
  return {
    ...
    problemSlugs: this.problemSlugs || [],
    status: this.status,
